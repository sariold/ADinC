...
void translate(FormTree *t){
     ...
     if((*t)->tt == Symbol && (*t)->t.symbol == '<'){
         ...
         Token tokAnd;
         tokAnd.symbol = '&';
         t4 = newFormTreeNode(Symbol, tok, t1->right, NULL);
         t3 = newFormTreeNode(Symbol, tok, t1->left, NULL);
         t2 = newFormTreeNode(Symbol, tokAnd, t3, t4);
         t5 = newFormTreeNode(Symbol, tokAnd, copy->left, copy->right);
         *t = newFormTreeNode(Symbol, tokOr, t5 , t2);
